...
const Galerie = () => {
    return (
        <Flex align="center" justify='center' style={{gap: '20px', padding: '20px'}} wrap>
          ...
          <CardFoto name='Februarie' description="Nu poti controla tot ce ti se intampla, dar poti controla modul in care reactionezi." imagePath={placeholder2} /> 
          <CardFoto name='Martie' description="Zambeste in fata provocarilor - ele sint pasii spre crestere" imagePath={placeholder} /> 
          <CardFoto name='Aprilie' description="O atitudine pozitiva poate transforma o zi obisnuita intr-una extraordinara" imagePath={placeholder2} /> 
          ...
          <CardFoto name='Iulie' description="O minte optimista vede o oportunitate in fiecare dificultate" imagePath={placeholder2} /> 
          ...
          <CardFoto name='Noiembrie' description="Ceea ce conteaza nu este ceea ce se intampla cu tine ci felul in care alegi sa alegi ce se intampla" imagePath={placeholder2} /> 

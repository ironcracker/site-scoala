...
const Calendar = () => {
    return (
        <Flex align="center" justify='center' style={{gap: '20px', padding: '20px'}} wrap>
          ...
          <CardFoto name={texte.Februarie} description={texte.textFebruarie} imagePath={placeholder} /> 
          <CardFoto name={texte.Martie} description={texte.textMartie} imagePath={placeholder} /> 
          <CardFoto name={texte.Aprilie} description={texte.textAprilie} imagePath={placeholder} /> 
          ...
          <CardFoto name={texte.Iulie} description={texte.textIulie} imagePath={placeholder} /> 
          ...
          <CardFoto name={texte.Noiembrie} description={texte.textNoiembrie} imagePath={placeholder} /> 
